...
public class TagTest {
	...
	public void tc00Test() {
		...
		tagsListPage.clickOnUpdateTag("Tag name marko");
	...
	//insert existing Test tag name 123 for tag name and click save and check result
	@Test
	public void tc05() {
	...
	public void tc09() {
		...
		assertTrue("Error message missing!",tagsAddPage.isErrorOnPage("This field is required."));
	}
	...
	public void tc12() {
		...
		assertTrue("Tag koji sam hteo da obrisem!", tagsListPage.isTagNameElementOnPage(updateTagName));
